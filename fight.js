...
function sumoDrawResult(ctx, won) {
  ...
  if (won) {
    ctx.fillStyle = '#ffd700'; ctx.font = 'bold 15px Inter,sans-serif';
    ctx.fillText('🪙 +25 Gold!', W/2, H/2+16);
  }
...
function sumoHandleInput(dir) {
  ...
  if (sumoPosition >= 10) {
    ...
    sumoSaveStats();
    try { if (typeof MQ !== 'undefined' && MQ.addGold) MQ.addGold(25); } catch(e) {}
...
function awDrawFinalResult(ctx, won) {
  ...
  if (won) {
    ctx.fillStyle = '#ffd700'; ctx.font = 'bold 15px Inter,sans-serif';
    ctx.fillText('🪙 +25 Gold!', W/2, H/2+18);
  }
...
<svg viewBox="0 0 526 520" xmlns="http://www.w3.org/2000/svg" class="comp-lobby-svg">
  ...
  <g class="comp-lobby-zone" onclick="PunchOut.startArmWrestling()">
    ...
    <!-- Two forearms actually facing off, each angled in from its own elbow pad to meet
         at the clasp in the middle — was two disconnected upright posts before, which
         read as furniture (goal posts) instead of arms locked in a wrestling grip. -->
    <line x1="300" y1="433" x2="383" y2="418" stroke="#e09870" stroke-width="17" stroke-linecap="round"/>
    <ellipse cx="300" cy="433" rx="11" ry="9" fill="#d08860"/>
    <line x1="492" y1="433" x2="405" y2="418" stroke="#f0b880" stroke-width="17" stroke-linecap="round"/>
    <ellipse cx="492" cy="433" rx="11" ry="9" fill="#e0a870"/>
    <!-- Clasped fist where the two forearms meet -->
    <ellipse cx="394" cy="420" rx="19" ry="14" fill="#c88858"/>
    <!-- Knuckle highlights -->
    <ellipse cx="386" cy="414" rx="6" ry="4" fill="#d4a070" opacity=".7"/>
    <ellipse cx="401" cy="413" rx="5" ry="4" fill="#d4a070" opacity=".7"/>
    <!-- Tension lines -->
