  ...
  return `<div class="trainer-lobby">
    ...
    <div class="trainer-scene-wrap">
      <svg viewBox="0 0 380 300" xmlns="http://www.w3.org/2000/svg" class="trainer-gym-svg">
        ...
        <!-- ═══ HIT CORNER atmospheric red glow (left) ═══ -->
        <rect x="0" y="65" width="118" height="160" fill="#ff0000" opacity=".022"/>
        <rect x="0" y="65" width="52" height="160" fill="#000" opacity=".32"/>

        <!-- Cable machine (Dorian) -->
        <rect x="0" y="75" width="10" height="150" fill="#111" rx="2"/>
        <rect x="2" y="112" width="7" height="10" rx="2" fill="#1e1e1e"/>
        <line x1="9" y1="117" x2="36" y2="163" stroke="#2a2a2a" stroke-width="2"/>

        <!-- ═══ DORIAN — bent over cable row ═══ -->
        <g transform="translate(16, 122)">
          <rect x="4" y="82" width="10" height="30" rx="4" fill="#7a5030" opacity=".85"/>
          <rect x="18" y="82" width="10" height="30" rx="4" fill="#7a5030" opacity=".85"/>
          <path d="M0 40 L5 84 L32 84 L36 40 Q30 30 18 28 Q6 30 0 40Z" fill="#7a5030" opacity=".9"/>
          <path d="M2 42 L7 82 L30 82 L34 42 Q28 34 18 32 Q8 34 2 42Z" fill="#080808" opacity=".9"/>
          <line x1="2" y1="52" x2="-10" y2="58" stroke="#7a5030" stroke-width="7" stroke-linecap="round"/>
          <line x1="-10" y1="58" x2="-14" y2="54" stroke="#7a5030" stroke-width="5" stroke-linecap="round"/>
          <line x1="34" y1="52" x2="42" y2="46" stroke="#7a5030" stroke-width="6" stroke-linecap="round"/>
          <ellipse cx="18" cy="22" rx="11" ry="11" fill="#7a5030" opacity=".9"/>
          <path d="M7 19 Q8 11 18 10 Q28 11 29 19" fill="#5a4030" opacity=".9"/>
          <circle cx="13" cy="22" r="1.5" fill="#050200" opacity=".9"/>
          <circle cx="23" cy="22" r="1.5" fill="#050200" opacity=".9"/>
          <path d="M10 19 Q13 17 16 19" stroke="#050200" stroke-width="1.2" fill="none"/>
          <path d="M20 19 Q23 17 26 19" stroke="#050200" stroke-width="1.2" fill="none"/>
          <path d="M12 27 Q18 30 24 27" stroke="#4a2a10" stroke-width="1.2" fill="none"/>
        </g>

        <!-- ═══ MENTZER — arms crossed, watching Dorian ═══ -->
        <g transform="translate(48, 110)">
          ...
          <!-- thick Mentzer mustache -->
          <path d="M12 24 Q20 29 28 24" stroke="#0d0500" stroke-width="4" fill="none" stroke-linecap="round"/>
          <circle cx="15" cy="19" r="2" fill="#1a0a00"/>
          <circle cx="25" cy="19" r="2" fill="#1a0a00"/>
          <circle cx="15.7" cy="18.2" r=".8" fill="#fff" opacity=".5"/>
          <circle cx="25.7" cy="18.2" r=".8" fill="#fff" opacity=".5"/>
          <path d="M11 15 Q15 13 19 15" stroke="#0d0500" stroke-width="1.4" fill="none"/>
          <path d="M21 15 Q25 13 29 15" stroke="#0d0500" stroke-width="1.4" fill="none"/>
        </g>

        <!-- ═══ CBUM — background dumbbell rack, small scale ═══ -->
        <g transform="translate(98, 90) scale(0.52)">
          <rect x="14" y="92" width="9" height="28" rx="4" fill="#c8a06a"/>
          <rect x="26" y="92" width="9" height="28" rx="4" fill="#c8a06a"/>
          <rect x="12" y="82" width="26" height="14" rx="4" fill="#0d4a7a"/>
          <path d="M10 46 L15 84 L35 84 L40 46 Q34 38 25 36 Q16 38 10 46Z" fill="#c8a06a"/>
          <path d="M12 48 L17 82 L33 82 L38 48 Q32 42 25 40 Q18 42 12 48Z" fill="#0d4a7a"/>
          <path d="M14 42 Q11 56 10 74" stroke="#c8a84b" stroke-width="4" fill="none" stroke-linecap="round"/>
          <path d="M36 42 Q39 56 40 72" stroke="#c8a84b" stroke-width="4" fill="none" stroke-linecap="round"/>
          <line x1="10" y1="60" x2="2" y2="48" stroke="#c8a06a" stroke-width="7" stroke-linecap="round"/>
          <rect x="-4" y="43" width="12" height="4" rx="2" fill="#555"/>
          <ellipse cx="-4" cy="45" rx="3" ry="5" fill="#3a3a3a"/>
          <ellipse cx="8" cy="45" rx="3" ry="5" fill="#3a3a3a"/>
          <line x1="38" y1="58" x2="46" y2="64" stroke="#c8a06a" stroke-width="6" stroke-linecap="round"/>
          <ellipse cx="25" cy="30" rx="13" ry="13" fill="#c8a06a"/>
          <path d="M12 25 Q13 17 25 16 Q37 17 38 25" fill="#c8a84b"/>
          <rect x="12" y="22" width="26" height="8" rx="5" fill="#c8a84b"/>
          <circle cx="20" cy="30" r="2" fill="#1a0a00"/>
          <circle cx="30" cy="30" r="2" fill="#1a0a00"/>
          <path d="M18 36 Q25 39 32 36" stroke="#a07848" stroke-width="1" fill="none"/>
        </g>

        <!-- ═══ CABLE POSTS (Arnold crossovers) ═══ -->
        ...
        <line x1="126" y1="90" x2="190" y2="152" stroke="#555" stroke-width="1.5"/>
        <line x1="254" y1="90" x2="190" y2="152" stroke="#555" stroke-width="1.5"/>

        <!-- ═══ ARNOLD — scaled down, cable crossovers center ═══ -->
        <g transform="translate(154, 104) scale(0.80)">
        ...
        <rect x="281" y="120" width="8" height="5" fill="#666" rx="1"/>
        <rect x="313" y="120" width="8" height="5" fill="#666" rx="1"/>
        <rect x="274" y="118" width="53" height="7" rx="3" fill="#777"/>
        <ellipse cx="277" cy="121" rx="6" ry="13" fill="#880000" stroke="#aa0000" stroke-width="1"/>
        <ellipse cx="324" cy="121" rx="6" ry="13" fill="#880000" stroke="#aa0000" stroke-width="1"/>
        <ellipse cx="271" cy="121" rx="4" ry="9" fill="#660000"/>
        <ellipse cx="330" cy="121" rx="4" ry="9" fill="#660000"/>

        <!-- ═══ RONNIE — squatting at rack ═══ -->
        <g transform="translate(276, 94)">
          <rect x="4" y="92" width="15" height="28" rx="5" fill="#9b6b45" transform="rotate(18,11,102)"/>
          <rect x="26" y="92" width="15" height="28" rx="5" fill="#9b6b45" transform="rotate(-18,33,102)"/>
          <rect x="3" y="82" width="42" height="15" rx="5" fill="#1a1a3a"/>
          <path d="M0 40 L6 84 L42 84 L48 40 Q40 28 24 26 Q8 28 0 40Z" fill="#9b6b45"/>
          <path d="M2 42 L8 82 L40 82 L46 42 Q38 32 24 30 Q10 32 2 42Z" fill="#1a1a3a"/>
          <text x="24" y="62" text-anchor="middle" font-size="4" fill="#3a3a6a" font-family="sans-serif">WORLD GYM</text>
          <line x1="0" y1="46" x2="-12" y2="42" stroke="#9b6b45" stroke-width="11" stroke-linecap="round"/>
          <line x1="-12" y1="42" x2="-16" y2="42" stroke="#9b6b45" stroke-width="8" stroke-linecap="round"/>
          <line x1="48" y1="46" x2="60" y2="42" stroke="#9b6b45" stroke-width="11" stroke-linecap="round"/>
          <line x1="60" y1="42" x2="64" y2="42" stroke="#9b6b45" stroke-width="8" stroke-linecap="round"/>
          <rect x="14" y="26" width="20" height="18" rx="5" fill="#9b6b45"/>
          <ellipse cx="24" cy="16" rx="15" ry="14" fill="#9b6b45"/>
          <ellipse cx="19" cy="10" rx="6" ry="4" fill="rgba(255,255,255,0.09)"/>
          <path d="M14 22 Q24 30 34 22" stroke="#7a4a20" stroke-width="2" fill="none" stroke-linecap="round"/>
          <path d="M15 23 Q24 29 33 23" fill="#fff" opacity=".42"/>
          <circle cx="17" cy="15" r="2.5" fill="#0a0500"/>
          <circle cx="31" cy="15" r="2.5" fill="#0a0500"/>
          <circle cx="17.8" cy="14" r="1" fill="#fff"/>
          <circle cx="31.8" cy="14" r="1" fill="#fff"/>
        </g>

        <!-- ═══ LOUIE — coaching beside rack with clipboard ═══ -->
        <g transform="translate(334, 140)">
          <rect x="6" y="78" width="10" height="28" rx="4" fill="#b07848"/>
          <rect x="20" y="78" width="10" height="28" rx="4" fill="#b07848"/>
          <rect x="4" y="48" width="28" height="34" rx="6" fill="#880000"/>
          <path d="M4 50 L7 82 L29 82 L32 50 Q26 42 18 40 Q10 42 4 50Z" fill="#b07848"/>
          <path d="M6 52 L9 80 L27 80 L30 52 Q24 46 18 44 Q12 46 6 52Z" fill="#880000"/>
          <!-- pointing arm toward Ronnie -->
          <line x1="5" y1="60" x2="-10" y2="54" stroke="#b07848" stroke-width="7" stroke-linecap="round"/>
          <line x1="-10" y1="54" x2="-17" y2="52" stroke="#b07848" stroke-width="5" stroke-linecap="round"/>
          <!-- clipboard arm -->
          <line x1="31" y1="62" x2="38" y2="68" stroke="#b07848" stroke-width="6" stroke-linecap="round"/>
          <rect x="36" y="65" width="10" height="14" rx="1" fill="#f4e8c0"/>
          <line x1="38" y1="69" x2="44" y2="69" stroke="#aaa" stroke-width=".8"/>
          <line x1="38" y1="72" x2="44" y2="72" stroke="#aaa" stroke-width=".8"/>
          <line x1="38" y1="75" x2="42" y2="75" stroke="#aaa" stroke-width=".8"/>
          <rect x="13" y="30" width="10" height="12" rx="4" fill="#c8a880"/>
          <ellipse cx="18" cy="22" rx="11" ry="12" fill="#c8a880"/>
          <path d="M7 19 Q8 11 18 10 Q28 11 29 19" fill="#9a9a9a"/>
          <rect x="7" y="16" width="22" height="7" rx="4" fill="#9a9a9a"/>
          <rect x="10" y="24" width="7" height="5" rx="2" fill="none" stroke="#777" stroke-width="1.2"/>
          <rect x="19" y="24" width="7" height="5" rx="2" fill="none" stroke="#777" stroke-width="1.2"/>
          <line x1="17" y1="26.5" x2="19" y2="26.5" stroke="#777" stroke-width="1"/>
          <circle cx="13.5" cy="26.5" r="1.2" fill="#1a0a00"/>
          <circle cx="22.5" cy="26.5" r="1.2" fill="#1a0a00"/>
          <path d="M13 33 Q18 37 23 33" stroke="#8a5030" stroke-width="1.2" fill="none" stroke-linecap="round"/>
        </g>

        <!-- ═══ PERSON AT WATER FOUNTAIN — tiny ═══ -->
        <g transform="translate(356, 155) scale(0.46)">
        ...
        <!-- ═══ NAME LABELS ═══ -->
        <text x="50" y="295" text-anchor="middle" font-size="7" fill="#ff444499" font-family="sans-serif" font-weight="700">HIT CORNER</text>
        <text x="28" y="287" text-anchor="middle" font-size="7" fill="#cc333355" font-family="sans-serif">Dorian</text>
        <text x="68" y="287" text-anchor="middle" font-size="7" fill="#cc333355" font-family="sans-serif">Mentzer</text>
        <text x="120" y="287" text-anchor="middle" font-size="7" fill="#88661144" font-family="sans-serif">CBum</text>
        <text x="190" y="295" text-anchor="middle" font-size="8" fill="#ffd70088" font-family="sans-serif">Arnold</text>
        <text x="300" y="287" text-anchor="middle" font-size="7.5" fill="#9e7cff66" font-family="sans-serif">Ronnie</text>
        <text x="345" y="287" text-anchor="middle" font-size="7" fill="#ff880066" font-family="sans-serif">Louie</text>

        <!-- ═══ INVISIBLE TAP ZONES — link each figure to their profile ═══ -->
        <rect x="0" y="100" width="52" height="130" fill="transparent" onclick="GainsShop.openTrainerProfile('dorian')" style="cursor:pointer"/>
        <rect x="44" y="100" width="56" height="130" fill="transparent" onclick="GainsShop.openTrainerProfile('mentzer')" style="cursor:pointer"/>
        <rect x="92" y="85" width="52" height="130" fill="transparent" onclick="GainsShop.openTrainerProfile('cbum')" style="cursor:pointer"/>
        <rect x="140" y="90" width="98" height="140" fill="transparent" onclick="GainsShop.openTrainerProfile('arnold')" style="cursor:pointer"/>
        <rect x="270" y="90" width="64" height="140" fill="transparent" onclick="GainsShop.openTrainerProfile('ronnie')" style="cursor:pointer"/>
        <rect x="328" y="128" width="52" height="120" fill="transparent" onclick="GainsShop.openTrainerProfile('louie')" style="cursor:pointer"/>
