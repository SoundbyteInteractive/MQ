...
<div class="mall-wrap">
  ...
  <div class="mall-scene-wrap">
    <svg viewBox="0 0 526 520" xmlns="http://www.w3.org/2000/svg" class="mall-scene-svg">
      ...
      <!-- 6. PAW & PROWL — COMING SOON  shifted left (visual x=303) -->
      <g class="mall-zone-cs" transform="translate(-77,0)">
        <rect x="380" y="53" width="72" height="161" fill="#1a1510"/>
        <!-- Awning — muted teal/cream -->
        <rect x="380" y="53" width="72" height="26" fill="#2a3a30"/>
        <rect x="380" y="53" width="72" height="2" fill="#3a5040"/>
        <rect x="380" y="77" width="72" height="2" fill="#2a3a30"/>
        <text x="416" y="63" text-anchor="middle" font-size="6.5" fill="#7ab898" font-family="sans-serif" font-weight="700">PAW &amp;</text>
        <text x="416" y="74" text-anchor="middle" font-size="5.5" fill="#5a8870" font-family="sans-serif" letter-spacing=".5">PROWL</text>
        <!-- Window frame -->
        <rect x="386" y="86" width="60" height="84" rx="3" fill="#0e100c" stroke="#2a4030" stroke-width="1.5"/>
        <rect x="388" y="88" width="56" height="80" rx="2" fill="#0a0e0a"/>
        <!-- Frosted/dark window — barely visible pet silhouettes -->
        <ellipse cx="404" cy="115" rx="11" ry="9" fill="#1a2018" opacity=".8"/>
        <ellipse cx="404" cy="108" rx="7" ry="7" fill="#1a2018" opacity=".8"/>
        <path d="M397 107 Q398 103 401 105" stroke="#1a2018" stroke-width="2" fill="none"/>
        <path d="M407 105 Q410 103 411 107" stroke="#1a2018" stroke-width="2" fill="none"/>
        <!-- Cat-like silhouette -->
        <ellipse cx="428" cy="118" rx="9" ry="7" fill="#182018" opacity=".8"/>
        <ellipse cx="428" cy="112" rx="6" ry="6" fill="#182018" opacity=".8"/>
        <path d="M422 111 Q423 107 426 109" stroke="#182018" stroke-width="2" fill="none"/>
        <path d="M430 109 Q433 107 434 111" stroke="#182018" stroke-width="2" fill="none"/>
        <!-- Paw prints on floor of window -->
        <circle cx="396" cy="150" r="3" fill="#2a3a28" opacity=".6"/>
        <circle cx="393" cy="147" r="1.5" fill="#2a3a28" opacity=".6"/>
        <circle cx="396" cy="145" r="1.5" fill="#2a3a28" opacity=".6"/>
        <circle cx="399" cy="147" r="1.5" fill="#2a3a28" opacity=".6"/>
        <circle cx="418" cy="153" r="3" fill="#2a3a28" opacity=".5"/>
        <circle cx="415" cy="150" r="1.5" fill="#2a3a28" opacity=".5"/>
        <circle cx="418" cy="148" r="1.5" fill="#2a3a28" opacity=".5"/>
        <circle cx="421" cy="150" r="1.5" fill="#2a3a28" opacity=".5"/>
        <!-- Door — boarded up -->
        <rect x="394" y="175" width="44" height="39" rx="2" fill="#1a1810"/>
        <rect x="396" y="177" width="40" height="35" rx="1" fill="#100e08"/>
        <line x1="396" y1="182" x2="436" y2="182" stroke="#2a2418" stroke-width="2"/>
        <line x1="396" y1="191" x2="436" y2="191" stroke="#2a2418" stroke-width="2"/>
        <line x1="396" y1="200" x2="436" y2="200" stroke="#2a2418" stroke-width="2"/>
        <line x1="396" y1="209" x2="436" y2="209" stroke="#2a2418" stroke-width="2"/>
        <!-- COMING SOON diagonal banner -->
        <rect x="380" y="48" width="72" height="166" fill="#000" opacity=".45" rx="2"/>
        <g transform="rotate(-35 416 131)">
          <rect x="378" y="125" width="76" height="14" fill="#ffd700"/>
          <text x="416" y="135" text-anchor="middle" font-size="6.5" fill="#000" font-family="sans-serif" font-weight="700" letter-spacing=".8">COMING SOON</text>
        </g>
        <!-- Lock icon -->
        <rect x="408" y="86" width="16" height="12" rx="3" fill="#ffd700"/>
        <path d="M411 86 Q416 80 421 86" stroke="#ffd700" stroke-width="2.5" fill="none" stroke-linecap="round"/>
        <circle cx="416" cy="93" r="2.5" fill="#8a6000"/>
      </g>
    ...
    <div class="trainer-scene-wrap">
      <svg viewBox="0 0 380 300" xmlns="http://www.w3.org/2000/svg" class="trainer-gym-svg">
        ...
        <g class="trainer-zone" onclick="GainsShop.openTrainerProfile('ronnie')">
          <rect x="254" y="50" width="86" height="158" fill="transparent"/>
          <!-- translate(272,77)scale(0.85): grip at 77+34*0.85=105.9≈106=barbell ✓; smaller=farther back -->
          <g transform="translate(272, 77) scale(0.85)">
          ...
          <g class="tz-label">
            <rect x="253" y="52" width="92" height="16" rx="4" fill="#000000dd"/>
            <text x="299" y="64" text-anchor="middle" font-size="8" fill="#fff" font-family="sans-serif" font-weight="600">Ronnie Coleman</text>
          </g>
        </g>
...
function openTrainerProfile(id) {
  ...
  // Page 5: Watch & Learn
  const ytSearch = encodeURIComponent(t.name + ' workout training');
  const page5 = `
  <div class="mag-page" style="background:#0d0f1a;padding:20px 16px 80px">
    ${pxTitle('🎬','Watch & Learn')}
    <div style="font-size:12px;color:rgba(255,255,255,0.45);margin-bottom:16px;line-height:1.5">
      Study how ${t.name.split(' ')[0]} actually trained. These videos are the closest thing to being in the gym with a legend.
    </div>
    <a class="mag-watch-card" href="https://www.youtube.com/results?search_query=${ytSearch}" target="_blank" rel="noopener">
      <div class="mag-watch-icon">▶️</div>
      <div>
        <div class="mag-watch-label">Search "${t.name}" on YouTube</div>
        <div class="mag-watch-sub">Training videos · Interviews · Documentary footage</div>
      </div>
    </a>
    <a class="mag-watch-card" href="https://www.youtube.com/results?search_query=${encodeURIComponent(t.name+' '+t.style)}" target="_blank" rel="noopener">
      <div class="mag-watch-icon">💪</div>
      <div>
        <div class="mag-watch-label">"${t.style}" Explained</div>
        <div class="mag-watch-sub">Deep dives into the method · Form guides</div>
      </div>
    </a>
