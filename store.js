...
<div class="store-scene">
  <div class="store-hdr">
    <span class="store-title">GAINS SHOP</span>
  ...
  <div class="store-room">
    ...
    <div class="shelf-row row1">
      ...
      ${soldOutShelves.slice(0, 1).map(() => `<div class="store-item sold-out">${renderBox(null, true)}<span class="item-lbl sold-lbl">Sold Out</span></div>`).join('')}
    </div>
    ...
    <div class="shelf-row row2">
      ...
      ${soldOutShelves.slice(1).map(() => `<div class="store-item sold-out">${renderBox(null, true)}<span class="item-lbl sold-lbl">Sold Out</span></div>`).join('')}
    </div>
    ...
    <div class="store-counter">
      ...
      <div class="store-cat" title="Meow">${renderCat()}</div>
    </div>
...
return { render, buyItem, getActiveBuffs, isBuffActive };
